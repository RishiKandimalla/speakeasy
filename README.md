...
Speakeasy is a mobile app for improving your public speaking. Record or upload a video of yourself speaking, and the app runs it through an AI pipeline that analyzes your delivery — filler words, pacing, grammar, tone, vocabulary — and returns structured coaching feedback with per-sentence tips.
...
3. **Results screen** shows a breakdown: filler word rate, WPM, grammar score, tone/confidence, vocabulary richness, and per-sentence coaching tips
...
|---|---|---|
| Transcription | AssemblyAI (`universal-2`) | Word-level speech-to-text |
...
| Coaching feedback | Gemini 2.5 Flash | Summary, strengths, improvements, tips, per-sentence notes |
| Tone / emotion | Hume AI (Speech Prosody) | Maps confidence and energy scores onto sentences |
...
│   └── app/
│       ├── api/           # REST endpoints (uploads, jobs, posts, profiles, clips, notifications, stats)
